...
partial class NLogViewerForm {
	...
	private void InitializeComponent() {
		...
		_optionsFlowLayoutPanel.Margin = new Padding(0);
		_optionsFlowLayoutPanel.Name = "_optionsFlowLayoutPanel";
		_optionsFlowLayoutPanel.Padding = new Padding(6, 6, 6, 0);
		...
		// _expandNewCheckBox
		// 
		_expandNewCheckBox.AutoSize = true;
		_expandNewCheckBox.Location = new Point(9, 15);
		_expandNewCheckBox.Margin = new Padding(3, 9, 0, 0);
		_expandNewCheckBox.Name = "_expandNewCheckBox";
		_expandNewCheckBox.Size = new Size(91, 19);
		...
		// _collapseButton
		// 
		_collapseButton.AutoSize = true;
		_collapseButton.Location = new Point(116, 9);
		_collapseButton.Margin = new Padding(16, 3, 0, 0);
		...
		_clearButton.Location = new Point(207, 9);
		_clearButton.Margin = new Padding(16, 3, 0, 0);
		...
		_filterPanel.Location = new Point(302, 9);
		_filterPanel.Margin = new Padding(20, 3, 0, 0);
		_filterPanel.Name = "_filterPanel";
		_filterPanel.Size = new Size(337, 30);
		...
		_clearFilterButton.Size = new Size(32, 26);
		...
		_optionsFlowLayoutPanel.PerformLayout();
	...
	private FlowLayoutPanel _optionsFlowLayoutPanel;
